...
describe('Controller redux interaction functions', () => {
  describe('Cart functions', () => {
    ...
    it('should add a quantity product to the cart', async () => {
      ...
      setProductsQuantityInCart(id, quantity, product);
      const updatedState = store.getState().cart;
    ...
    it('should remove all item product from the cart', () => {
      const id = '17';
      removeAllProductsFromCart(id, product);
      const removeState = store.getState().cart;
    ...
    it('should remove all cart', () => {
      ...
      setProductsQuantityInCart(PRODUCT_ONE.id, PRODUCT_ONE.quantity, product);
      setProductsQuantityInCart(PRODUCT_TWO.id, PRODUCT_TWO.quantity, product);
